...
public class Emp {
	...
	private String job;
	private Integer mgr; // 필드 선언시에 기본값을 넣을 수 있다.
...
//	private Integer deptno;
	 ...
	 * 	
	 * 	OneToMany 또는 ManyToMany 관계는 다른 Entity 를 List 의 Generic type 으로 가지고 있다.
	 */
	@ManyToOne // 많은 Emp 가 하나의 Dept 에 속해 있다
	// 이 칼럼의 이름은 deptno 이고 Dept 테이블의 deptno 를 참조하고 있다.
