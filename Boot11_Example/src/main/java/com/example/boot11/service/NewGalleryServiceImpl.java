...
import com.example.boot11.repository.NewGalleryDao;

@Service
public class NewGalleryServiceImpl implements NewGalleryService{
	...
	@Autowired private NewGalleryDao dao;
	...
	@Override
	public void addToGallery(NewGalleryDto dto) {
		/*
	...
	public void selectOne(Model model, int num) {
		...
		NewGalleryDto dto = dao.getData(num);
	...
	public void selectPage(Model model, int pageNum) {
		...
		NewGalleryDto dto = new NewGalleryDto();
		dto.setStartRowNum(startRowNum);
		dto.setEndRowNum(endRowNum);
			
		//GalleryDao 객체를 이용해서 회원 목록을 얻어온다.
		List<NewGalleryDto> list = dao.getList(dto);
