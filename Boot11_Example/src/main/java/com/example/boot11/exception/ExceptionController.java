...
public class ExceptionController {
	 ...
	 * 일반 컨트롤러 처럼 필요한 객체를 매개 변수에 선언하면 스프링이 알아서 전달해 준다.
...
//	}
	...
	public String password(PasswordException pe, RedirectAttributes ra) {
	  ...
	  @ExceptionHandler(AccessDeniedException.class)
	    public String DeleteFile(AccessDeniedException ad, Model model) {
		  	model.addAttribute("exception", ad);
	        return "/file/delete_fail";
	    }
